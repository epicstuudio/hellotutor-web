...
function GuidelineCard({ item, icon }: { item: GuidelineItem; icon: React.ReactNode }) {
  return (
    ...
    >
      ...
      <h3 className="text-body-lg font-semibold text-content mb-2">{item.title}</h3>
    ...
    >
      <div className="flex items-start gap-5">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-h4 text-content tracking-tight mb-4">{section.title}</h2>
            ...
            <main className="flex-1 min-w-0">
              ...
              >
                <div className="mb-6">
                  ...
                  <h2 className="text-h3 text-content tracking-tight">{t('guidelines.title')}</h2>
                </div>
              ...
              >
                <div className="mb-6">
                  ...
                  <h2 className="text-h3 text-content tracking-tight">
