...
export function Footer() {
  ...
  return (
    <footer className="bg-content text-content-invert pt-16 overflow-hidden">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-0 mb-12 lg:mb-0">
          {/* Left Column */}
          <div className="flex flex-col lg:col-span-2 lg:pe-12 lg:pb-12">
            <div className="mb-6">
              <Logo variant="white" />
            </div>
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://www.instagram.com/joinhellotutor"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/80 hover:bg-white/20 hover:text-white transition-colors"
                aria-label="Instagram"
              >
                <svg viewBox="0 0 511 511.9" className="w-4 h-4" fill="currentColor">
              ...
              <a
                href="https://www.linkedin.com/company/hello-tutor/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/80 hover:bg-white/20 hover:text-white transition-colors"
                aria-label="LinkedIn"
            ...
            <div className="mt-8 lg:mt-auto">
              <TrustBadge textClassName="text-white/70" />
            </div>
          </div>

          {/* Right Column with middle divider */}
          <div className="flex flex-col relative lg:col-span-3 lg:ps-16 lg:border-s border-white/10 lg:pb-12">
            {/* Top Links */}
            ...
            <div className="relative h-px mb-12">
              <div className="absolute top-0 left-0 lg:-left-16 w-full lg:w-[100vw] border-t border-white/10" />
            </div>
      ...
      <div className="bg-[#0F0F0F]">
        <Container>
          <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-[13px] text-white/70">
