...
export function InteractiveDashboard() {
  ...
  return (
    <div className={`w-full relative text-left overflow-hidden rounded-[16px] md:rounded-[24px] border shadow-2xl ${isDarkMode ? 'dark border-[#2A2D31]' : 'border-slate-200'}`}>
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-6">
                ...
                {/* Up Next Card */}
                <motion.div variants={itemVariants} className="bg-white dark:bg-[#1C1C1D] rounded-[16px] border border-slate-200 dark:border-[#2A2D31] shadow-sm p-6 relative overflow-hidden group transition-colors duration-300">
                ...
                {/* Pending Tasks */}
                <motion.div variants={itemVariants} className="bg-white dark:bg-[#1C1C1D] rounded-[16px] border border-slate-200 dark:border-[#2A2D31] shadow-sm p-5 transition-colors duration-300">
                  <div className="mb-4">
              ...
              {/* Stats Grid */}
                <motion.div variants={itemVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-white dark:bg-[#1C1C1D] rounded-[16px] border border-slate-200 dark:border-[#2A2D31] shadow-sm p-5 hover:shadow-md transition-all duration-300">
                ...
                {/* Chart Card */}
                <motion.div variants={itemVariants} className="bg-white dark:bg-[#1C1C1D] rounded-[16px] border border-slate-200 dark:border-[#2A2D31] shadow-sm p-6 transition-colors duration-300">
