    ...
    <section className="relative overflow-hidden bg-surface pt-[calc(72px+8rem)] xl:pt-[calc(88px+8rem)] pb-16 lg:pb-24">
      <Container className="relative z-10 w-full h-full">
        <div className="flex flex-col justify-center z-10 max-w-3xl mx-auto lg:mx-0 text-center lg:text-start">
          ...
          >
            <HighlightText words="Monthly">{t('pricingPageHero.titleLine1')}</HighlightText>
            <br className="hidden lg:block" />
            {t('pricingPageHero.titleLine2')}
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-body-xl text-content-secondary max-w-2xl mb-10 mx-auto lg:mx-0"
          >
            {t('pricingPageHero.subtitle')}
          </motion.p>
          ...
          >
            <Button
              ...
              size="lg"
              className="w-full sm:w-auto bg-[#75ED4D] hover:bg-[#66d142] text-black border-none flex items-center justify-center gap-2"
              target="_blank"
          ...
          <motion.p
            ...
            className="text-body-xs text-content-tertiary"
          >
            {t('hero.noCommitment')}
          </motion.p>
        </div>
