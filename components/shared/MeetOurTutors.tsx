    ...
    <section className={cn("py-12 lg:py-20 bg-surface-brand-alt text-content-invert", className)}>
      <Container>
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-body-lg text-content-invert/90">
            {t('subtitle')}
          </p>
        </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-6 mb-12">
              {standards.map((standard, idx) => (
                <div key={idx} className="flex gap-4 items-start border-b border-content-invert/10 pb-6 last:border-b-0 last:pb-0">
                  <CheckCircle2 className="w-6 h-6 shrink-0 mt-0.5 text-content-invert opacity-80" />
                  <p className="text-body text-content-invert/90 leading-relaxed">
                    {standard}
                  </p>
                </div>
              ))}
